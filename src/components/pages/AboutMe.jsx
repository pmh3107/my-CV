          ...
          <div className="content">
            ...
            <div className="content__info-all">
              <p className="content__info">
                ...
                fourth-year IT student, I've honed my skills to become a skilled
                front-end developer. I'm fluent in HTML, CSS, and have a grasp
                of JavaScript, React, and web app development. Plus, I'm a TOEIC
                600+ holder!
              </p>
              <p className="content__info">
